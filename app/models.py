...
# ==================== CẬP NHẬT CÁC CLASS MODELS ====================

# Thay thế method get_media_seo_info() trong class Product:
# (Xóa method cũ ở dòng 70-83 và thay bằng cái này)
...
def product_get_media_seo_info(self):
    ...
    # Fallback: dùng thông tin từ Product
    return {
